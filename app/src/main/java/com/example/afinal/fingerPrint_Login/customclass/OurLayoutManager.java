...
import com.stone.vega.library.StartSnapHelper;
...
public class OurLayoutManager extends LinearLayoutManager {
    ...
    public OurLayoutManager(Context context) {
        super(context);
    }
    ...
    public void onAttachedToWindow(RecyclerView view) {
        ...
        new OurSnapHelper().attachToRecyclerView(view);
    }
